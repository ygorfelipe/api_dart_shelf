...
class Order {
  ...
  @override
  String toString() {
    return 'Order(id: $id, name: $name, address: $address, order_id: $orderId, order_total: $orderTotal, provider: $provider, order_provider_id: $orderProviderId, status: $status, created_at: $createdAt, updated_at: $updatedAt)';
  }
}
